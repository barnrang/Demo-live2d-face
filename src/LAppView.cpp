...
void LAppView::Render(cv::VideoCapture& cap)
{
...
void LAppView::InitializeSprite()
{
    ...
    x = static_cast<float>(width - 0.5 * gearTexture->width);
    y = static_cast<float>(height - 0.5 * gearTexture->height);
    ...
    _power = new LAppSprite(-1, -1, 0, 0, powerTexture->id);
