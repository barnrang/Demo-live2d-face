...
void LAppLive2DManager::OnUpdate(cv::VideoCapture& cap) const
{
    ...
    {
        projection.Scale(5.f, static_cast<float>(5 * windowWidth) / static_cast<float>(1. * windowHeight));
		projection.TranslateY(-2.0);
    }
